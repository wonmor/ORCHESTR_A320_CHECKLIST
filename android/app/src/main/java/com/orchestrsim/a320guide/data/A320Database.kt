...
object A320Database {
    ...
    val normalChecklists: List<Checklist> by lazy { listOf(
        cockpitPreparation,
        beforeStart,
        afterStart,
        beforeTaxi,
    ...
    val cockpitPreparation = Checklist(
    ...
    val descentPreparation = Checklist(
    ...
    val approachChecklist = Checklist(
        title = "Approach",
    ...
    val landingChecklist = Checklist(
        title = "Landing",
    ...
    val afterLanding = Checklist(
        title = "After Landing",
        subtitle = "Post-touchdown procedures",
        icon = "road.lanes",
        phase = FlightPhase.POST_FLIGHT,
        items = mutableListOf(
    ...
    val emergencyProcedures: List<EmergencyProcedure> by lazy { listOf(
        engineFireGround,
        engineFireFlight,
    ...
    val engineFireGround = EmergencyProcedure(
    ...
    val engineFireFlight = EmergencyProcedure(
    ...
    val engineFailureAfterV1 = EmergencyProcedure(
    ...
    val rejectedTakeoff = EmergencyProcedure(
    ...
    val dualEngineFailure = EmergencyProcedure(
    ...
    val emergencyDescent = EmergencyProcedure(
    ...
    val rapidDepressurization = EmergencyProcedure(
    ...
    val smokeRemoval = EmergencyProcedure(
    ...
    val emergencyEvacuation = EmergencyProcedure(
    ...
    val unreliableAirspeed = EmergencyProcedure(
    ...
    val windshearEscape = EmergencyProcedure(
    ...
    val ditching = EmergencyProcedure(
        title = "Ditching",
    ...
    val fuelLeak = EmergencyProcedure(
        title = "Fuel Leak",
    ...
    val hydraulicFailure = EmergencyProcedure(
    ...
    val electricalEmergency = EmergencyProcedure(
    ...
    val lossOfBraking = EmergencyProcedure(
    ...
    val instrumentGuides: List<InstrumentGuide> by lazy { listOf(
        pfdGuide,
        ndGuide,
        ecamGuide,
        fcuGuide,
    ...
    val pfdGuide = InstrumentGuide(
        ...
        sections = listOf(
            InstrumentSection(title = "Airspeed Tape (Left Side)", items = listOf(
            ...
            InstrumentSection(title = "Attitude Indicator (Center)", items = listOf(
            ...
            InstrumentSection(title = "Altitude Tape (Right Side)", items = listOf(
            ...
            InstrumentSection(title = "Vertical Speed (Far Right)", items = listOf(
            ...
            InstrumentSection(title = "Heading / Track (Bottom)", items = listOf(
            ...
            InstrumentSection(title = "FMA (Flight Mode Annunciator — Top)", items = listOf(
    ...
    val ndGuide = InstrumentGuide(
        ...
        sections = listOf(
            InstrumentSection(title = "Display Modes", items = listOf(
            ...
            InstrumentSection(title = "Range Selection", items = listOf(
            ...
            InstrumentSection(title = "Overlays", items = listOf(
            ...
            InstrumentSection(title = "Information Fields", items = listOf(
    ...
    val ecamGuide = InstrumentGuide(
        ...
        sections = listOf(
            InstrumentSection(title = "Upper ECAM (Engine/Warning Display)", items = listOf(
            ...
            InstrumentSection(title = "Lower ECAM (System Display)", items = listOf(
            ...
            InstrumentSection(title = "ECAM Warning Levels", items = listOf(
    ...
    val fcuGuide = InstrumentGuide(
        ...
        sections = listOf(
            InstrumentSection(title = "Speed Window (Left)", items = listOf(
            ...
            InstrumentSection(title = "Heading Window (Left-Center)", items = listOf(
            ...
            InstrumentSection(title = "Altitude Window (Right-Center)", items = listOf(
            ...
            InstrumentSection(title = "Vertical Speed / FPA Window (Right)", items = listOf(
            ...
            InstrumentSection(title = "Autopilot Buttons", items = listOf(
    ...
    val mcduGuide = InstrumentGuide(
        ...
        sections = listOf(
            InstrumentSection(title = "Key Pages", items = listOf(
            ...
            InstrumentSection(title = "PERF Pages Detail", items = listOf(
            ...
            InstrumentSection(title = "Color Coding", items = listOf(
    ...
    val overheadGuide = InstrumentGuide(
        name = "Overhead Panel",
        abbreviation = "OHP",
        ...
        sections = listOf(
            InstrumentSection(title = "Panel Sections (Front to Rear)", items = listOf(
            ...
            InstrumentSection(title = "Dark Cockpit Philosophy", items = listOf(
    ...
    val pedestalGuide = InstrumentGuide(
        ...
        sections = listOf(
            InstrumentSection(title = "Thrust Levers & Engine Controls", items = listOf(
            ...
            InstrumentSection(title = "Flight Controls", items = listOf(
            ...
            InstrumentSection(title = "Communications", items = listOf(
            ...
            InstrumentSection(title = "Other Controls", items = listOf(
    ...
    val glareshieldGuide = InstrumentGuide(
        name = "Glareshield",
        ...
        sections = listOf(
            InstrumentSection(title = "EFIS Control Panel (one per pilot)", items = listOf(
            ...
            InstrumentSection(title = "Warning/Caution Lights", items = listOf(
    ...
    val autopilotGuide = InstrumentGuide(
        ...
        sections = listOf(
            InstrumentSection(title = "Autopilot Modes", items = listOf(
            ...
            InstrumentSection(title = "Lateral Modes", items = listOf(
            ...
            InstrumentSection(title = "Vertical Modes", items = listOf(
            ...
            InstrumentSection(title = "Thrust Modes", items = listOf(
            ...
            InstrumentSection(title = "Protections (Normal Law)", items = listOf(
    ...
    val radioGuide = InstrumentGuide(
        ...
        sections = listOf(
            InstrumentSection(title = "Radio Management Panel (RMP)", items = listOf(
            ...
            InstrumentSection(title = "Audio Control Panel (ACP)", items = listOf(
            ...
            InstrumentSection(title = "Transponder", items = listOf(
    ...
    val ilsApproach = ApproachProcedure(
        ...
        requiredEquipment = listOf("ILS receiver (dual for CAT II/III)", "Glideslope receiver", "Marker receiver (optional)", "Radio altimeter", "Autopilot (dual for CAT III)"),
        steps = listOf(
    ...
    val vorApproach = ApproachProcedure(
        name = "VOR Approach",
        ...
        requiredEquipment = listOf("VOR receiver", "DME (if VOR/DME)", "Radio altimeter recommended"),
        steps = listOf(
    ...
    val vorDmeApproach = ApproachProcedure(
        name = "VOR/DME Approach",
        type = ApproachType.VOR_DME,
        icon = "antenna.radiowaves.left.and.right",
        ...
        requiredEquipment = listOf("VOR receiver", "DME receiver", "Radio altimeter recommended"),
        steps = listOf(
    ...
    val ndbApproach = ApproachProcedure(
        name = "NDB Approach",
        ...
        requiredEquipment = listOf("ADF receiver", "Radio altimeter recommended"),
        steps = listOf(
    ...
    val rnavApproach = ApproachProcedure(
        ...
        requiredEquipment = listOf("GPS/GNSS receiver (FMGC)", "SBAS for LPV (if equipped)", "Radio altimeter"),
        steps = listOf(
    ...
    val visualApproach = ApproachProcedure(
        ...
        requiredEquipment = listOf("Visual reference to runway", "Minimum VMC weather conditions"),
        steps = listOf(
    ...
    val circlingApproach = ApproachProcedure(
        name = "Circling Approach",
        type = ApproachType.CIRCLING,
        ...
        requiredEquipment = listOf("Instrument approach equipment for initial approach", "Visual reference for circling maneuver"),
        steps = listOf(
    ...
    val locOnlyApproach = ApproachProcedure(
        name = "Localizer Only Approach",
        type = ApproachType.LOC,
        ...
        requiredEquipment = listOf("ILS localizer receiver", "DME (if LOC/DME)", "Radio altimeter"),
        steps = listOf(
    ...
    val dirToFunction = FMGCOperation(
    ...
    val holdFunction = FMGCOperation(
    ...
    val secondaryFlightPlan = FMGCOperation(
    ...
    val limitations = POHSection(
        ...
        subsections = listOf(
            POHSubsection(title = "Speed Limitations", content = listOf(
            ...
            POHSubsection(title = "Weight Limitations", content = listOf(
            ...
            POHSubsection(title = "Altitude Limitations", content = listOf(
            ...
            POHSubsection(title = "Engine Limitations (CFM56-5B / PW1100G)", content = listOf(
            ...
            POHSubsection(title = "Environmental Limitations", content = listOf(
    ...
    val weightBalance = POHSection(
        title = "Weight & Balance",
        icon = "scalemass",
        subsections = listOf(
            POHSubsection(title = "Reference Data", content = listOf(
            ...
            POHSubsection(title = "Fuel Tank Capacities", content = listOf(
    ...
    val performanceTables = POHSection(
        title = "Performance Reference",
        icon = "chart.line.uptrend.xyaxis",
        subsections = listOf(
            POHSubsection(title = "Takeoff Performance (Sea Level, ISA)", content = listOf(
            ...
            POHSubsection(title = "Cruise Performance", content = listOf(
            ...
            POHSubsection(title = "Approach & Landing Performance", content = listOf(
            ...
            POHSubsection(title = "Single Engine Performance", content = listOf(
    ...
    val systemsDescription = POHSection(
        title = "Systems Description",
        icon = "gearshape.2",
        subsections = listOf(
            POHSubsection(title = "Engines", content = listOf(
            ...
            POHSubsection(title = "Hydraulic System", content = listOf(
            ...
            POHSubsection(title = "Electrical System", content = listOf(
            ...
            POHSubsection(title = "Flight Control System", content = listOf(
            ...
            POHSubsection(title = "Pressurization & Air Conditioning", content = listOf(
            ...
            POHSubsection(title = "Fuel System", content = listOf(
